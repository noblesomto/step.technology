        ...
        <div class="row login-register-area">
            <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 pull-right">
                <div class="content-box ">
                    ...
                    <div class="sec-title">
                        <h1>Register as Corporate Professional</h1>
                    ...
                    <div class="row">
                        <form action="/register-corporate-professional" method="POST">
                        @csrf
                            <div class="col-md-12">
                                @if ($errors->has('title'))
                            ...
                            <div class="col-md-12">
                                ...
                                @endif
                                <div class="input-field">
                                    <input type="text" name="profession" placeholder="Professional Discipline *" required value="{{ old('profession') }}">
                                    <div class="icon-holder">
                                        <i class="fa fa-user" aria-hidden="true"></i>
                                    </div>
                                </div>    
                ...
                <div class="left-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="page-link">
                            ...
                            <li><a class="active" href="/register-corporate-professional">Corporate Professional</a></li>
                            <li><a href="register-corporate-organization">Corporate Organization</a></li>             
                        </ul>
                    </div>
                    <!--End single sidebar-->
