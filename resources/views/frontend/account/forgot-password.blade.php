...
@include('frontend.layouts.tailwind.page-header', ['pageTitle' => 'Account Section', 'breadcrumb' => 'Forgot Password'])

<section class="py-16">
    <div class="max-w-lg mx-auto px-4">
        <div class="text-center mb-8">
            <h1 class="font-step-heading font-bold text-2xl sm:text-3xl text-step-primary">Forgot Password</h1>
        ...
        <form action="/forgot-password" method="POST" class="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 space-y-4">
            @csrf
            <div class="relative">
                <input type="email" name="email" placeholder="Enter Email Address *" required class="w-full rounded-md border-gray-300 focus:border-step-primary focus:ring-step-primary text-sm pl-11 pr-4 py-2.5">
