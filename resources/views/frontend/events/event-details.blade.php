                ...
                <div class="blog-post">
                    ...
                    <div class="single-blog-item">
                        <div class="img-holder">
                            <img src="{{ asset('uploads/event/'.$event->event_picture) }}" alt="{{ $event->event_title }}">
                            <div class="post-date">
                                <h5>{{ $event->created_at->format('j F ');  }}</h5>    
                            </div>
                        </div>
                        <div class="text-holder">
                            
                            <h3 class="blog-title">{{ $event->event_title }}</h3>
                            <ul class="meta-info">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="social-share pull-right">
                                    ...
                                    <ul class="social-share-links">
                                        ...
                                        <li><a href="https://twitter.com/share?url={{ url()->current(); }}/&amp;text={{ $event->event_title }}&amp;hashtags=Ifynwuke" target="_blank"><i class="fa fa-twitter"></i></a></li>
