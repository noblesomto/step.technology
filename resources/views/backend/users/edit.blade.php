...
<div class="mb-6">
    <h1 class="font-step-heading font-bold text-2xl text-gray-900">Edit User</h1>
...
<div class="bg-white rounded-lg border border-gray-200 p-6 sm:p-8 max-w-3xl">
    <form action="/admin/users/{{ $user->user_id }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')

        @include('backend.users._form', ['user' => $user, 'passwordRequired' => false])
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="/admin/users/{{ $user->user_id }}" class="text-sm font-step-heading font-semibold text-gray-500 hover:text-step-primary">Cancel</a>
        </div>
    </form>
</div>
