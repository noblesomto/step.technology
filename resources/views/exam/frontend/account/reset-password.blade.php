...
<section class="bg-body p-2 md:pt-10">
    <div class="max-w-5xl mx-auto">
        <div class="flex flex-col justify-center items-center">
            <h3 class="text-xl md:text-[30px] font-semibold">Enter new Password</h3>
    ...
    <div class="max-w-2xl mx-auto bg-white p-3 md:p-10 mt-4 md:mt-10 mb-20 rounded-lg">
        ...
        <form class="register-form validate-form" action="/reset-password/{{ $post['user_id'] }}/{{ $post['token'] }}" method="POST" enctype="">
          ...
          <div class="mb-4 relative">
            ...
            @endif
            <label class="text-sm font-semibold">Password *</label>
            <input type="password" id="password1" name="password_confirmation" placeholder="Confirm your password" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('password_confirmation') }}" required>
            
            <!-- Show/Hide Button -->
            <button type="button"  class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-500 mt-6">
              <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M10 3C5.4 3 1.73 6.11.4 10c1.33 3.89 5 7 9.6 7s8.27-3.11 9.6-7C18.27 6.11 14.6 3 10 3zM10 15a5 5 0 110-10 5 5 0 010 10zm0-8a3 3 0 100 6 3 3 0 000-6z" />
              </svg>
            </button>
