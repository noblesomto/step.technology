    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="bg-grey-100 px-6 pb-20 flex-grow">
            <div class="container mx-auto p-1">
		        <h1 class="text-3xl font-bold my-3">Profile Settings</h1>
		        ...
		        <div class="">
		        	...
		        	<div class="max-w-2xl mx-auto bg-white p-3 md:p-10 mt-4 md:mt-10 mb-20 rounded-lg">
				        <form method="POST" action="/landlord/profile" enctype="multipart/form-data">
				            @csrf
				            @method('PUT')
		...
		@include('exam.landlord.layouts.footer')
    </div>
</div>
