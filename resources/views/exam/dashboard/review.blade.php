		            ...
		            <div class="grid grid-cols-1 md:grid-cols-10 gap-6">
		            	...
		            	<div class="col-span-10 md:col-span-5">
		            		<div class="p-6 bg-white">
			            		...
			            		@endif
			            		<form id="ratingForm" method="POST" action="/submit-review/{{ $book_id }}" >
			            			@csrf
			            			...
			            			<div class="mb-4 mt-4">
							            ...
							            @endif
							            <textarea name="comment" rows="5" class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required></textarea>
							            
							        </div>
							        <p id="errorMessage" class="text-red-500 text-sm mt-2 hidden">Please select a rating before submitting.</p>
							        <div class="mt-5 flex">
							        	<button type="submit" class="btn2 btn-red py-2 px-7 mr-5">Submit Review</button>
							        </div>
			            		</form>
		            		</div>
		            	</div>
